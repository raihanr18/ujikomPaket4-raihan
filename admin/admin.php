  ...
  <div id="wrapper">
        ...
        <div id="sidebar-wrapper">
            ...
            <ul class="sidebar-nav">
                ...
                <li>
                    <a href="src/jumlahBarang.php" >Jumlah Barang</a>
                </li>
                <li>
                    <a href="src/jumlahLelang.php">Jumlah Lelang</a>
                </li>
                <li>
                    <a href="src/jumlahUser.php">Jumlah User</a>
                </li>
                <li>
                    <a href="src/jumlahPetugas.php" >Jumlah Petugas</a>
                </li>
                <li>
                    <a href="src/historiLelang.php">Histori Lelang</a>
                </li>
                <li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <center>
                    <h1 style="margin-top:2.5cm; color:white;"><strong>HALAMAN ADMIN</strong></h1>
                    <hr>
                    <h3 style="color:white;">Hai Admin, <?php session_start(); echo $_SESSION['username']; ?></h3>
                    </center>
                    <a href="#menu-toggle" class="btn btn-light" id="menu-toggle">Kontrol Admin</a>
                  <hr>
