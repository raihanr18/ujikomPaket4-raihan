        ...
        <div id="sidebar-wrapper">
            ...
            <ul class="sidebar-nav">
                ...
                echo "<li>
                  ...
                  echo "<li>
                    <a href='petugas/petugas.php'>Dashboard</a>
                </li>";
                }
                ?>
                <li>
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                  ...
                  <h1 style="color:white;"><strong><u>Jumlah Lelang</u></strong></h1>
                  <br>
                  ...
                  <table class="table">
                    <thead class="thead-dark">
                      <tr>
                        ...
                        <th class="col">Id petugas</th>
                        <th class="col">Tgl lelang</th>
                        <th class="col">Harga akhir</th>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <br>
                          <a href="proses_hapus_paket.php?id=<?php echo $b['id_lelang']; ?>" class="btn btn-danger" onclick="return confirm('untuk menghapus data ini?')"> Hapus</a>
                        </td>
                      </tr>
                    </tbody>
                    <?php endforeach; ?>
