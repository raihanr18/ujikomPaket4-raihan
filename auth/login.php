...
if (isset($_POST["login"])){
  ...
  if (mysqli_num_rows($result) === 1){
    ...
    if (password_verify($pass, $cek["password"]) ){
      ...
      header("location:dashboard/lelang.php");
    }
...
?>
  ...
  <small style="color:white" class="form-text">Belum mempunyai akun ? buat <a href="auth/register.php" style="color:white;">Disini</a></small>
</form>
</center>
